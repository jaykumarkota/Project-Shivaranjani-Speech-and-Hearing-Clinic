...
import "../styles/components/FloatingContactButton.css";
...
function FloatingContactButton() {
    ...
    return (
        <div className="floating-contact-wrapper">
            ...
            {/* Main Toggle Button */}
            <button
                className={`floating-contact-btn ${isExpanded ? "active" : ""}`}
                onClick={toggleExpand}
                aria-label="Contact options"
            >
                <span className={`btn-icon ${isExpanded ? "rotated" : ""}`}>
                    {isExpanded ? (
